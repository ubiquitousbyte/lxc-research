...
The benchmark tool's is located in \verb|src/conty/src/bench| relative to the 
...
image is then exported into a tar archive which can be extracted. Our custom container runtime 
