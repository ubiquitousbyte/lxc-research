...
\ref{code:implementation/namespaces/mount}, is an absolute necessity before calling \verb|pivot_root|.
Otherwise, unmounting the root filesystem may propagate downstream to the host, causing it to 
unmount as well.
