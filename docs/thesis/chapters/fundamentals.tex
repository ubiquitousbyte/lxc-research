...
to be wrapped in a sandbox. In that case, the environment in which every program is instantiated would have to 
satisfy all three virtualisation axioms.
...
Furthermore, guests do not boot up complete operating system images, which practically eliminates 
boot times.
\textcite{10.1145/3126908.3126925} use operating system virtualisation in high-performance 
