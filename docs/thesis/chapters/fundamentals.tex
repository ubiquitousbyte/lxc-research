...
Given the aforementioned homomorphism, a virtual machine can host a \textit{guest kernel} that runs completely in user mode. 
...
The authors show the negative effects that on-disk image size has by starting images with 
...
and isolated application environments running on top of a shared kernel. 
