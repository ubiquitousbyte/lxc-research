...
mynewhostname 
\end{lstlisting}
Example (\ref{ccode:fundamentals/namespaces/user-example}) highlights how the kernel authorises operations in a user namespace.
...
the mount namespace of the container. Changes in one mount point are reflected in the other 
using copy on write. 
