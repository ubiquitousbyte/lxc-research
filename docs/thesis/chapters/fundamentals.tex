...
First, the heap grows upwards and may overlap with the stack. Second, a Unix system usually 
has a system-wide heap from which processes acquire memory. If a long-running process executes 
