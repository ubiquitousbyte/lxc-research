...
A process is the primary unit of work in a computer system. It represents a program in execution. 
The kernel partitions the linear address space of a process into multipe regions shown in Figure 
