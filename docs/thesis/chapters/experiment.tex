...
The round-trip times on theh ost and from the client container are shown in Figure \ref{images:experiment/network-host-rtt.pdf}
...
on the host, while Figure \ref{images:experiment/network-host-throughput.pdf} shows the 
