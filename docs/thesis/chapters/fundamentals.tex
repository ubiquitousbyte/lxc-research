...
\begin{lstlisting}[style=syscalls, caption={Fork System Call Wrapper}]
#include <unistd.h>
...
\lstinputlisting[label={code:os-concepts/src/fork.c}, style=c-code-snippets, caption={os-concepts/src/fork.c}, firstline=11, lastline=31]
